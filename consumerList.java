...
public class consumerList {
	...
	public consumerList(int size, int producer_sleep_time, int consumer_sleep_time, int N_messages){
	...
	public void runSimulation() throws InterruptedException{
			...
			Thread p1 = new Thread("P1"){
				public void run(){
					...
					for(int i = 0; i < number_OF_messages; i++){
						...
						produceItem(current_buffer);
						consumed++;
						//System.out.println("Producer 1 changed CONSUMED TO: " + consumed);
			...
			Thread p2 = new Thread("P2"){
				public void run(){
					...
					for(int i = 0; i < number_OF_messages; i++){
						...
						produceItem(current_buffer);
						consumed++;
						//System.out.println("Producer 2 changed CONSUMED to: " + consumed);
					}
			...
			System.out.println("The Average Wait Time for the Consumers is: " + String.format("%.2f",computeAverage(consumer_wait_time)));
	...
	public static void main(String[] args) {
			consumerList b =  new consumerList(10,20,20,50);
			try {
				b.runSimulation();
			} catch (InterruptedException e) {
				e.printStackTrace();
